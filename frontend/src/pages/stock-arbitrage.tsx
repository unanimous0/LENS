    ...
    <div className="flex flex-col h-full bg-black">
      ...
      <div className="flex-1 overflow-auto min-h-0 px-2">
        <table className="w-max min-w-full border-collapse">
          ...
          <tbody>
            {filtered.map((r) => (
              <tr key={r.baseCode} className="border-b border-white/[0.04] hover:bg-white/[0.08] transition-colors">
                {/* 종목 */}
                <td className="pl-4 pr-3 py-[11px] sticky left-0 bg-black z-10">
