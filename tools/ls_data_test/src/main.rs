...
const SUBSCRIPTIONS: &[(&str, &str)] = &[
    ...
    // 주식선물은 매월 만기. 2026-05-26 기준: 근월=6월(6), 차월=7월(7)  ← futures_master.json 확인
    ...
    // ── Phase 6: 지수선물 ────────────────────────────────────────────────
    // 지수선물은 분기물 (3/6/9/12월). 근월=6월, 차월=9월.
    // 코드 형식: A + 품목(01=KOSPI200, 06=KOSDAQ150) + 연도끝자리(6) + 월(hex) + 000
    // t8467 실측(2026-05-26): A0166000(6월), A0169000(9월), A016C000(12월)
    // t8435 실측(2026-05-26): A0666000(6월), A0669000(9월), A066C000(12월)
    //
    // FC9(체결) + FH9(호가, 5단 — JH0의 10단과 다름)
    ("FC9", "A0166000"),  ("FC9", "A0169000"),  // KOSPI200 6월·9월물 체결
    ("FH9", "A0166000"),                        // KOSPI200 6월물 호가
    // KOSDAQ150 선물: FC9 vs JC0 미확인 — FC9 (지수선물) 시도
    ("FC9", "A0666000"),  ("FC9", "A0669000"),  // KOSDAQ150 6월·9월물 — FC9로 시도
    ...
    // ── Phase 8: 한화오션 선물 체결 확인 — LENS 현재가 갱신 디버그 ─────────
    ("JC0", "AFV66000"),  // 한화오션 6월물
];
