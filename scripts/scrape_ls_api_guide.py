...
def main():
    ...
    md_chunks = [
        ...
        "",
        "**신/구 매핑 사례**:",
        "- t8414 / **t8415** / t8416 (선물 차트 구) → **t8464 / t8465 / t8466** (`[선물/옵션] 차트` 그룹)",
        "- t8410 / t8411 / t8412 (주식 차트, 일부 가이드 노출) → t8451 / t8452 / t8453 (`[주식] 차트` 그룹 통합 API용)",
        "- t2101 / t2105 / t2201 / t2203 등 (선물 시세 구) → t2111 / t2112 / t2212 / t2214 등 (`[선물/옵션] 시세` 그룹)",
        "",
        "WebSocket TR (FC0/FH0/FX0/YFC, ELW 일부) 같이 신 TR 매핑 못 찾는 경우만 LS 포털에서 PDF 별도.",
        "",
    ]
    if missing_groups:
