...
use super::tick::{
    EtfTick, FuturesTick, IndexFuturesDepthTick, IndexFuturesTick, OrderbookTick, StockTick,
    VolumeTick,
};
...
pub enum WsMessage {
    ...
    /// 지수선물 총잔량 (LS FH9). "선물" 탭의 매도/매수 총잔량 + 비율. product별 500ms throttle.
    #[serde(rename = "index_futures_depth")]
    IndexFuturesDepth(IndexFuturesDepthTick),
