...
(표본 09:10~15:20 클린창 — 선물 30초봉 풀세션 적재 확인, 2026-09-16).
...
- 선물 30초봉은 초기 설계 때 LS 500봉/일 상한으로 11:26~만 가정했으나, **FD 실측(2026-09-16)
  08:45:30~15:45 풀세션 적재 확인** (2026-01-02부터 전 기간, 오후만 있는 날 0일) — s 표본은
  클린창 09:10~15:20 전체다. 쿼리가 시간창 파라미터라 별도 코드 변경 없이 이미 반영돼 있었다.
...
# 두 축의 하한을 따로 잡는다 (선물이 11:26~만 있던 시기의 보수값 유지 — 풀세션인 지금은 여유):
#   s = 469봉/일 하한 기준  →  1400 ≈ 3일 (실제 약 730봉/일)
